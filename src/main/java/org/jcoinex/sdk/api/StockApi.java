...
public class StockApi {
    ...
    private final String SYS_TIME = "https://api.coinex.com/perpetual/v1/time";
    ...
    public long getCoinexSystemTime() throws IOException, HttpException {
		HttpUtilManager httpUtil = HttpUtilManager.getInstance();
    	return CoinexResponseDeserializer.deserializeDataAsLong(httpUtil.requestHttpGet(SYS_TIME, "", null, null));
